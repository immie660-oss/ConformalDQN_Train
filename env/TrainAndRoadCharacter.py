...
#次渠道路坡度
gradStartPoint=[4360,5404,6588,6697]
gradList=[2,-3,3,2]#[2,-3,3,2]
#gradList=[2,-3,12,8]
#次渠路段限速
# SLStartPoint=[20103,20283,21449,21569]
SLStartPoint=[4360,5404,6588,6697]
...
def plotSpeedLimitRoadGrad(style):
    #style:relative :相对坐标
    #      abstract: 绝对坐标
    #   Mat=tool.ReadCSVMat('.\subway_system\speedLimit_songjiazhuang')
    # Mat=tool.ReadCSVMat('.\subway_system\speedLimit_ciqu')
    # Mat=tool.ReadCSVMat('.\subway_system\speedLimit_ciqu')
    Mat=tool.ReadCSVMat('C:\\Users\\OJ\\Desktop\\code\\q-learning_xiansu_podu-master\\subway_system\\speedLimit_3')
    startPoint=Mat[:,0]
...
def ReadBrakeSpeedLimitCurve():
    ...
    with open('C:\\Users\\OJ\\Desktop\\code\\q-learning_xiansu_podu-master\\subway_system\\speedLimit_3.csv',mode='r',encoding='UTF-8-sig') as file_obj:
    # with open('D:\\yjjx\\code\\q-learning_xiansu_podu-master\\subway_system\\speedLimit_ciqu', mode='r', encoding='UTF-8-sig') as file_obj:
...
def getRunState(pos, switchPoint, stateTable=None):
...
if __name__ == '__main__':   
    plotSpeedLimitRoadGrad('relative')    
